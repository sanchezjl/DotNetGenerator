...
class ExpressionTemplate {
	...
	«expression.typeSpecification.typeSpecificationString.toFirstUpper»'''
	...
	/**
	 * Este método escribe el equivalente en C# de los símbolos (Operadores Binarios)
	...
	/**
	 * Este método escribe los valores literales para C#
	 */
